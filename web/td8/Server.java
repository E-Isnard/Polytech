...
public class Server {
  ...
  /**
  * Methode a utiliser quand on veut transferer un ensemble de bytes,
  * e.g. contenu d'un fichier.
  */
  ...
  /**
  * Methode a utiliser quand on veut transferer un nombre len de bytes.
  */
  public void write(byte[] buff, int len) throws IOException{
    new DataOutputStream(client.getOutputStream()).write(buff, 0, len);
  }

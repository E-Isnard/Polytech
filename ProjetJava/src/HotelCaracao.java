...
/**
 * HotelCaracao: Classe principale qui permet de jouer un client qui arrive à l'hotel Caracao
 * On ne joue qu'un seul client, meme si on peut imaginer qu'il soit accompagner.
 * 
 */
...
public class HotelCaracao {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // On demande au client quelle activité il veut faire
        int choix = 0;
            ...
            if (choix == 1) {
                ...
                while (go) {
                    ...
                    try {
                        ...
                        casino.roulette(mise); //Si le montant de la mise est plus grand que le nombre de jetons qu'on a
                ...
                prixTotal -= 2 * nbJetons; //Prix total peut etre negatif si on a gagne plus d'argent au casino que ce que l'on doit a l'hotel
                ...
                System.out.println("Que vous-vous commander ?");
                ...
                while (!finDeCommande) {
                    ...
                    finDeCommande = (continuerCommander.equals("O") || continuerCommander.equals("o"));// Si on repond o
                                                                                                       // ou O on arrete
                                                                                                       // de commander
                ...
                while (continuerMassage) {
                    ...
                    //Si on repond "o" ou "O" on arrete de commander des massages
        ...
        //On affiche un message differents en fonction de si on doit de l'argent ou non a l'hotel
        prixTotal = Math.ceil(prixTotal*100)/100; //On arondit deux chiffres apres la virgules
        if(prixTotal<=0){
